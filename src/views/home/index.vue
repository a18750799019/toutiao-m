  ...
  <div class="home page-container">
    ...
    <div class="nav-bar">
      ...
      <van-button class="search-btn"
                  ...
                  size="small"
                  icon="search"
                  @click="$router.push('/searcha')">搜索</van-button>
    </div>
    <!-- /导航栏 -->
    ...
    <van-tabs ref="tabs"
      ...
      <!-- tabbar的slot   click直接控制data值改变 一个slot可以插多个东西-->
...
.home {
  .nav-bar {
    ...
    z-index: 1;
    .logo {
      background: url(https://sf1-scmcdn2-tos.pstatp.com/mobile_list/image/wap_logo@3x_581de69e.png);
